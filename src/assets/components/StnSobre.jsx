  ...
  <>
    <sectio className="sobre">
      ...
      <ul className="sobre-lista">
        <li className="sobre-lista-resumo">
          <h2 className="sobre-lista-resumo-atendimento">Atendimento</h2>
          <ul className="sobre-lista-resumo-atendimento-lista">
            <li className="sobre-lista-resumo-atendimento-lista-processos">
        ...
        <li className="sobre-lista-resumo">
          <h2 className="sobre-lista-resumo-reparos-tecnicos">
            Reparos Técnicos
          </h2>
          <p className="sobre-lista-resumo-desricao">
        ...
        <li className="sobre-lista-resumo">
          <h2 className="sobre-lista-resumo-pagamento-facilitado">
            Pagamento Facilitado
          </h2>
          <p className="sobre-lista-resumo-descricao">
